...
The gene models track could be expanded to display alternative splicing events, offering a clearer view of transcript diversity. Additionally, adding a hover-based popup over each bin that displays gene models for accessions containing variants could offer a rapid and informative view of variant differences.
...
\bibitem{ucsc_trix}
University of California, Santa Cruz. (n.d.). Trix Index Files. UCSC Genome Browser.
\end{thebibliography}
\end{document}
